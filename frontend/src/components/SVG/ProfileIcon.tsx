...
export default function ProfileIcon() {
  return (
    <div>
      ...
      >
        <g
          className="stroke: none; strokeWidth: 0; strokeDasharray: none; strokeLinecap: butt; strokeLinejoin: miter; strokeMiterlimit: 10; fill: none; fillRule: nonzero; opacity: 1;"
        ...
        >
          <path
            ...
            className="stroke: none; strokeWidth: 1; stroke-dasharray: none; strokeLinecap: butt; strokeLinejoin: miter; strokeMiterlimit: 10; fill: rgb(0,0,0); fillRule: nonzero; opacity: 1;"
